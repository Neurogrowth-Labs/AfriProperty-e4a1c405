...
const SearchBar: React.FC<SearchBarProps> = ({ onSearch, isSearchingAI, filters, onFilterChange, searchError }) => {
        ...
        <div className="bg-white/10 dark:bg-slate-800/10 backdrop-blur-2xl p-3 rounded-[2rem] shadow-2xl w-full border border-white/20">
            <div className="bg-transparent">
                ...
                <div className="p-6 bg-white dark:bg-slate-800 rounded-2xl shadow-xl">
                    ...
                    {searchError && (
                        <div className="mt-3 bg-red-50 text-red-600 dark:bg-red-900/30 dark:text-red-300 px-4 py-3 rounded-xl text-sm font-medium animate-fade-in text-center border border-red-100 dark:border-red-800">
                            {searchError}
                        </div>
                    )}
                </div>
